<style>
    ...
    .bubbles-pattern::before {
        ...
        right: -50px;
        bottom: -50px;
        background: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200"><defs><radialGradient id="bubbleGrad1" cx="0.3" cy="0.3"><stop offset="0%" stop-color="white" stop-opacity="0.4"/><stop offset="60%" stop-color="white" stop-opacity="0.2"/><stop offset="100%" stop-color="white" stop-opacity="0.1"/></radialGradient><radialGradient id="bubbleGrad2" cx="0.25" cy="0.25"><stop offset="0%" stop-color="white" stop-opacity="0.35"/><stop offset="70%" stop-color="white" stop-opacity="0.15"/><stop offset="100%" stop-color="white" stop-opacity="0.08"/></radialGradient><radialGradient id="bubbleGrad3" cx="0.35" cy="0.35"><stop offset="0%" stop-color="white" stop-opacity="0.3"/><stop offset="80%" stop-color="white" stop-opacity="0.12"/><stop offset="100%" stop-color="white" stop-opacity="0.05"/></radialGradient><radialGradient id="bubbleGradFaint" cx="0.3" cy="0.3"><stop offset="0%" stop-color="white" stop-opacity="0.2"/><stop offset="70%" stop-color="white" stop-opacity="0.08"/><stop offset="100%" stop-color="white" stop-opacity="0.03"/></radialGradient><radialGradient id="bubbleGradBright" cx="0.28" cy="0.28"><stop offset="0%" stop-color="white" stop-opacity="0.35"/><stop offset="55%" stop-color="white" stop-opacity="0.18"/><stop offset="100%" stop-color="white" stop-opacity="0.08"/></radialGradient><pattern id="bubbles1" width="200" height="200" patternUnits="userSpaceOnUse"><circle cx="30" cy="30" r="4" fill="url(%23bubbleGradBright)"/><circle cx="130" cy="130" r="3.5" fill="url(%23bubbleGrad2)"/><circle cx="80" cy="20" r="3" fill="url(%23bubbleGradFaint)"/><circle cx="20" cy="110" r="5" fill="url(%23bubbleGrad1)"/><circle cx="160" cy="60" r="3.2" fill="url(%23bubbleGradFaint)"/><circle cx="60" cy="160" r="4.2" fill="url(%23bubbleGradBright)"/><circle cx="100" cy="80" r="2.5" fill="url(%23bubbleGrad3)"/><circle cx="170" cy="170" r="3.8" fill="url(%23bubbleGrad2)"/><circle cx="40" cy="185" r="3" fill="url(%23bubbleGradFaint)"/><circle cx="150" cy="190" r="2.5" fill="url(%23bubbleGrad3)"/></pattern></defs><rect width="200" height="200" fill="url(%23bubbles1)"/></svg>');
        animation: floatPattern1 20s ease-in-out infinite;
    }

    /* Motif plus dense pour la hero section */
    .hero-section .bubbles-pattern::before {
        background: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200"><defs><radialGradient id="bubbleGradHero1" cx="0.3" cy="0.3"><stop offset="0%" stop-color="white" stop-opacity="0.5"/><stop offset="60%" stop-color="white" stop-opacity="0.25"/><stop offset="100%" stop-color="white" stop-opacity="0.12"/></radialGradient><radialGradient id="bubbleGradHero2" cx="0.25" cy="0.25"><stop offset="0%" stop-color="white" stop-opacity="0.45"/><stop offset="70%" stop-color="white" stop-opacity="0.2"/><stop offset="100%" stop-color="white" stop-opacity="0.1"/></radialGradient><radialGradient id="bubbleGradHero3" cx="0.35" cy="0.35"><stop offset="0%" stop-color="white" stop-opacity="0.4"/><stop offset="80%" stop-color="white" stop-opacity="0.15"/><stop offset="100%" stop-color="white" stop-opacity="0.08"/></radialGradient><radialGradient id="bubbleGradHeroFaint" cx="0.3" cy="0.3"><stop offset="0%" stop-color="white" stop-opacity="0.25"/><stop offset="70%" stop-color="white" stop-opacity="0.1"/><stop offset="100%" stop-color="white" stop-opacity="0.04"/></radialGradient><radialGradient id="bubbleGradHeroBright" cx="0.28" cy="0.28"><stop offset="0%" stop-color="white" stop-opacity="0.45"/><stop offset="55%" stop-color="white" stop-opacity="0.22"/><stop offset="100%" stop-color="white" stop-opacity="0.1"/></radialGradient><pattern id="bubbles1-hero" width="200" height="200" patternUnits="userSpaceOnUse"><circle cx="30" cy="30" r="3.5" fill="url(%23bubbleGradHeroBright)"/><circle cx="130" cy="130" r="3.2" fill="url(%23bubbleGradHero2)"/><circle cx="80" cy="20" r="2.8" fill="url(%23bubbleGradHeroFaint)"/><circle cx="20" cy="110" r="4" fill="url(%23bubbleGradHero1)"/><circle cx="160" cy="60" r="3" fill="url(%23bubbleGradHeroFaint)"/><circle cx="60" cy="160" r="3.6" fill="url(%23bubbleGradHeroBright)"/><circle cx="100" cy="80" r="2.5" fill="url(%23bubbleGradHero3)"/><circle cx="170" cy="170" r="3.3" fill="url(%23bubbleGradHero2)"/><circle cx="40" cy="185" r="3" fill="url(%23bubbleGradHeroFaint)"/><circle cx="150" cy="190" r="2.5" fill="url(%23bubbleGradHero3)"/><circle cx="70" cy="50" r="2.8" fill="url(%23bubbleGradHeroFaint)"/><circle cx="180" cy="40" r="3.5" fill="url(%23bubbleGradHeroBright)"/><circle cx="45" cy="90" r="2.2" fill="url(%23bubbleGradHero3)"/><circle cx="120" cy="25" r="2.8" fill="url(%23bubbleGradHeroFaint)"/><circle cx="90" cy="150" r="3.2" fill="url(%23bubbleGradHero2)"/><circle cx="15" cy="75" r="2.5" fill="url(%23bubbleGradHero3)"/></pattern></defs><rect width="200" height="200" fill="url(%23bubbles1-hero)"/></svg>');
    }
    ...
    .static-bubble-front {
        ...
        opacity: 0.6;  /* Réduction globale de l'opacité */
    }
